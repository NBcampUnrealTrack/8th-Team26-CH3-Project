...
#include "Team26/public/Sensor/Team26CameraSensorTypes.h"
...
class TEAM26_API UCameraSensorComponent : public USceneComponent
{
	GENERATED_BODY()
...
private:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "CameraSensor|Output",
		meta = (AllowPrivateAccess = "true"))
