// Team26CameraSensorTypes.h

#pragma once

#include "CoreMinimal.h"
#include "Team26CameraSensorTypes.generated.h"
...
struct FBevRenderConfig
{
	...
	FLinearColor PointColor = FLinearColor(1.0f, 0.0f, 0.2f, 1.0f);
...
struct FLensDistortionParams
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "LensDistortion")
	float K1 = -0.3f;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "LensDistortion")
	float K2 = 0.1f;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "LensDistortion")
