...
#include "Team26OffroadCar.h"
#include "Team26OffroadWheelFront.h"
#include "Team26OffroadWheelRear.h"
...
ATeam26OffroadCar::ATeam26OffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UTeam26OffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UTeam26OffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UTeam26OffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UTeam26OffroadWheelRear::StaticClass();
